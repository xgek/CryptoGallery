// src/lib.rs
/*
 * Core library for CryptoGallery
 */
...
#[derive(Debug)]
pub struct CryptoGalleryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoGalleryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoGallery processing");
    
    let mut processor = CryptoGalleryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoGalleryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoGalleryProcessor::new(false);
